 ...
 */
void ICACHE_FLASH_ATTR si446x_reset(void)
{
    U8 loopCount;
 ...
 */
void ICACHE_FLASH_ATTR si446x_power_up(U8 BOOT_OPTIONS, U8 XTAL_OPTIONS, U32 XO_FREQ)
{
 ...
 * Before this function @si446x_reset should be called.
 */
U8 ICACHE_FLASH_ATTR si446x_configuration_init(const U8* pSetPropCmd)
{
 ...
 */
void ICACHE_FLASH_ATTR si446x_part_info(void)
{
 ...
 */
void ICACHE_FLASH_ATTR si446x_start_tx(U8 CHANNEL, U8 CONDITION, U16 TX_LEN)
{
 ...
 */
void ICACHE_FLASH_ATTR si446x_start_rx(U8 CHANNEL, U8 CONDITION, U16 RX_LEN, U8 NEXT_STATE1, U8 NEXT_STATE2, U8 NEXT_STATE3)
{
 ...
 */
void ICACHE_FLASH_ATTR si446x_get_int_status(U8 PH_CLR_PEND, U8 MODEM_CLR_PEND, U8 CHIP_CLR_PEND)
{
 ...
 */
void ICACHE_FLASH_ATTR si446x_gpio_pin_cfg(U8 GPIO0, U8 GPIO1, U8 GPIO2, U8 GPIO3, U8 NIRQ, U8 SDO, U8 GEN_CONFIG)
{
...
#endif
void ICACHE_FLASH_ATTR si446x_set_property( U8 GROUP, U8 NUM_PROPS, U8 START_PROP, ... )
{
    va_list argList;
    U8 cmdIndex;
 ...
 */
void ICACHE_FLASH_ATTR si446x_change_state(U8 NEXT_STATE1)
{
 ...
 */
void ICACHE_FLASH_ATTR si446x_nop(void)
{
 ...
 */
void ICACHE_FLASH_ATTR si446x_fifo_info(U8 FIFO)
{
 ...
 */
void ICACHE_FLASH_ATTR si446x_write_tx_fifo(U8 numBytes, U8* pTxData)
{
 ...
 */
void ICACHE_FLASH_ATTR si446x_read_rx_fifo(U8 numBytes, U8* pRxData)
{
 ...
 */
void ICACHE_FLASH_ATTR si446x_get_property(U8 GROUP, U8 NUM_PROPS, U8 START_PROP)
{
 ...
 */
void ICACHE_FLASH_ATTR si446x_func_info(void)
{
 ...
 */
void ICACHE_FLASH_ATTR si446x_frr_a_read(U8 respByteCount)
{
 ...
 * @param respByteCount Number of Fast Response Registers to be read.
 */
void ICACHE_FLASH_ATTR si446x_frr_b_read(U8 respByteCount)
{
 ...
 * @param respByteCount Number of Fast Response Registers to be read.
 */
void ICACHE_FLASH_ATTR si446x_frr_c_read(U8 respByteCount)
{
 ...
 * @param respByteCount Number of Fast Response Registers to be read.
 */
void ICACHE_FLASH_ATTR si446x_frr_d_read(U8 respByteCount)
{
 ...
 */
void ICACHE_FLASH_ATTR si446x_get_adc_reading(U8 ADC_EN)
{
 ...
 */
void ICACHE_FLASH_ATTR si446x_get_packet_info(U8 FIELD_NUMBER_MASK, U16 LEN, S16 DIFF_LEN )
{
 ...
 */
void ICACHE_FLASH_ATTR si446x_get_ph_status(U8 PH_CLR_PEND)
{
 ...
 */
void ICACHE_FLASH_ATTR si446x_get_modem_status( U8 MODEM_CLR_PEND )
{
 ...
 */
void ICACHE_FLASH_ATTR si446x_get_chip_status( U8 CHIP_CLR_PEND )
{
 ...
 */
void ICACHE_FLASH_ATTR si446x_ircal(U8 SEARCHING_STEP_SIZE, U8 SEARCHING_RSSI_AVG, U8 RX_CHAIN_SETTING1, U8 RX_CHAIN_SETTING2)
{
 ...
 * @param IRCAL_PH
 */
void ICACHE_FLASH_ATTR si446x_ircal_manual(U8 IRCAL_AMP, U8 IRCAL_PH)
{
 ...
 */
void ICACHE_FLASH_ATTR si446x_request_device_state(void)
{
 ...
 */
void ICACHE_FLASH_ATTR si446x_tx_hop(U8 INTE, U8 FRAC2, U8 FRAC1, U8 FRAC0, U8 VCO_CNT1, U8 VCO_CNT0, U8 PLL_SETTLE_TIME1, U8 PLL_SETTLE_TIME0)
{
 ...
 * @param VCO_CNT0  New VCO_CNT0 register value.
 */
void ICACHE_FLASH_ATTR si446x_rx_hop(U8 INTE, U8 FRAC2, U8 FRAC1, U8 FRAC0, U8 VCO_CNT1, U8 VCO_CNT0)
{
 ...
 *
 */
void ICACHE_FLASH_ATTR si446x_start_tx_fast( void )
{
    Pro2Cmd[0] = SI446X_CMD_ID_START_TX;
 ...
 *
 */
void ICACHE_FLASH_ATTR si446x_start_rx_fast( void )
{
    Pro2Cmd[0] = SI446X_CMD_ID_START_RX;
 ...
 *
 */
void ICACHE_FLASH_ATTR si446x_get_int_status_fast_clear( void )
{
    Pro2Cmd[0] = SI446X_CMD_ID_GET_INT_STATUS;
 ...
 *
 */
void ICACHE_FLASH_ATTR si446x_get_int_status_fast_clear_read(void)
{
    Pro2Cmd[0] = SI446X_CMD_ID_GET_INT_STATUS;
 ...
 * Reads back current GPIO pin configuration. Does NOT configure GPIO pins
  *
 */
void ICACHE_FLASH_ATTR si446x_gpio_pin_cfg_fast( void )
{
    Pro2Cmd[0] = SI446X_CMD_ID_GPIO_PIN_CFG;
...
void ICACHE_FLASH_ATTR si446x_disp_gpio_pin_cfg( void )
{
    printf("GPIO PIN CFG: GPIO %3d %3d %3d %3d NIRQ: 0x%02x SDO: 0x%02x GEN_CFG: 0x%02x\n",
            ...
            Si446xCmd.GPIO_PIN_CFG.GPIO[3] & 0x3f,
 ...
 *
 */
void ICACHE_FLASH_ATTR si446x_get_ph_status_fast_clear( void )
{
    Pro2Cmd[0] = SI446X_CMD_ID_GET_PH_STATUS;
    Pro2Cmd[1] = 0;
 ...
 *
 */
void ICACHE_FLASH_ATTR si446x_get_ph_status_fast_clear_read(void)
{
    Pro2Cmd[0] = SI446X_CMD_ID_GET_PH_STATUS;
 ...
 *
 */
void ICACHE_FLASH_ATTR si446x_get_modem_status_fast_clear( void )
{
    Pro2Cmd[0] = SI446X_CMD_ID_GET_MODEM_STATUS;
    Pro2Cmd[1] = 0;
 ...
 *
 */
void ICACHE_FLASH_ATTR si446x_get_modem_status_fast_clear_read( void )
{
    Pro2Cmd[0] = SI446X_CMD_ID_GET_MODEM_STATUS;
 ...
 *
 */
void ICACHE_FLASH_ATTR si446x_get_chip_status_fast_clear( void )
{
    Pro2Cmd[0] = SI446X_CMD_ID_GET_CHIP_STATUS;
    Pro2Cmd[1] = 0;
 ...
 *
 */
void ICACHE_FLASH_ATTR si446x_get_chip_status_fast_clear_read( void )
{
    Pro2Cmd[0] = SI446X_CMD_ID_GET_CHIP_STATUS;
 ...
 *
 */
void ICACHE_FLASH_ATTR si446x_fifo_info_fast_reset(U8 FIFO)
{
    Pro2Cmd[0] = SI446X_CMD_ID_FIFO_INFO;
    Pro2Cmd[1] = FIFO;
 ...
 *
 */
void ICACHE_FLASH_ATTR si446x_fifo_info_fast_read(void)
{
    Pro2Cmd[0] = SI446X_CMD_ID_FIFO_INFO;
